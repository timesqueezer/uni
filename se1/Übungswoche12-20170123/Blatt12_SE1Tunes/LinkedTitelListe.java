...
class LinkedTitelListe implements TitelListe
{
    ...
    public void fuegeEin(Titel titel, int position)
    {
        ...
        DoppellinkKnoten aktuellerKnoten = _listenkopf;
        ...
        DoppellinkKnoten neuerKnoten = new DoppellinkKnoten(titel, 
                                                aktuellerKnoten.gibVorgaenger(),
                                                aktuellerKnoten);
        aktuellerKnoten.setzeVorgaenger(neuerKnoten);
    ...
    public boolean enthaelt(Titel titel)
    {
        ...
        {
            aktuellerKnoten = aktuellerKnoten.gibNachfolger();
            if (aktuellerKnoten.gibTitel().equals(titel)) {
                return true;
            }
        }
