...
The thesis hypothesizes that machine learning systems incorporating federated learning perform better than non-federated counterparts while maintaining user privacy. It assumes that users perform actions on websites using a mouse or touchpad which are hard to fake by attackers trying to emulate human behavior. Chunks of 10-20 mouse events are used as input parameters. \cite{9111596} show that 10 events should be used as a miniumum for the similar task of user identity prediction. Multiple results can be averaged to increase detection performance.
...
% https://figshare.com/articles/dataset/Mouse_Behavior_Data_for_Static_Authentication/5619313

% additional:
% https://www.uvic.ca/ecs/ece/isot/datasets/?utm_medium=redirect&utm_source=/engineering/ece/isot/datasets/&utm_campaign=redirect-usage#section0-3
