...
While no suitible datasets exist that include both request and mouse data, many publicly available datasets exist that contain valid user mouse movement and click data.
...
Antal et. al's dataset \cite{9111596} includes around 20-30 sessions of 21 users and is used to validate the transferability of this method.
...
When scoring the trained model with "User1"'s data as the test set, the model's accuracy increases to $99.11\%$.
