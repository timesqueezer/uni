...
\begin{table}
    \begin{center}
        \begin{tabular}{lrrrrrr}
            ...
            Scenario & Accuracy & Precision & Recall & F1 Score & AUC & Training Time \\
            \midrule
            Adv. training data, basic test data & 0.769 & 0.938 & 0.577 & 0.714 & 0.928 & 1.306 \\
            Basic training data, adv. test data & 0.529 & 0.952 & 0.061 & 0.115 & 0.765 & 0.888 \\
            \bottomrule
        \end{tabular}
    \end{center}
...
\begin{table}
    \begin{center}
        \begin{tabular}{lrrrrrr}
            ...
            Scenario & Accuracy & Precision & Recall & F1 Score & AUC & Training Time \\
            \midrule
            W1 training data, W2 test data & 0.966 & 0.955 & 0.964 & 0.960 & 0.993 & 1.075 \\
            W2 training data, W1 test data & 0.914 & 0.715 & 0.961 & 0.820 & 0.983 & 0.524 \\
            \bottomrule
        \end{tabular}
    \end{center}
