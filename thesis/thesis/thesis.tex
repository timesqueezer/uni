...
The advanced mouse bot uses an additional library to provide additional interpolation methods. PyAutoGUI\footenote{\url{https://pyautogui.readthedocs.io/en/latest/}} provides the required functionality and can easily be extended.
