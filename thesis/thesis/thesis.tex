...
To empirically determine the best Random Forest parameters both mouse and request data from the experiment's first website and generated bots (same number of sessions as human users) were used to calculate the performance for combinations of the following parameters:
...
\begin{table}
	\begin{center}
		\begin{tabular}{|l|l|l|l|l|l|l|l|}
			\hline
			Max Features & \# Estimators & Max Depth & Accuracy & Precision & Recall & F1 Score & AUC \\
			\hline
			None & 10 & None & 0.972 & 0.984 & 0.977 & 0.981 & 0.997 \\
			\hline
			log2 & 10 & None & 0.967 & 0.970 & 0.985 & 0.977 & 0.992 \\
			\hline
			sqrt & 10 & None & 0.967 & 0.970 & 0.985 & 0.977 & 0.992 \\
			\hline
			log2 & 1000 & None & 0.961 & 0.962 & 0.985 & 0.973 & 0.996 \\
			\hline
			sqrt & 200 & None & 0.961 & 0.962 & 0.985 & 0.973 & 0.996 \\
			\hline
			None & 100 & None & 0.961 & 0.969 & 0.977 & 0.973 & 0.996 \\
			\hline
			sqrt & 1000 & None & 0.961 & 0.962 & 0.985 & 0.973 & 0.996 \\
			\hline
			None & 150 & None & 0.961 & 0.969 & 0.977 & 0.973 & 0.997 \\
			\hline
			log2 & 100 & None & 0.961 & 0.962 & 0.985 & 0.973 & 0.996 \\
			\hline
			None & 200 & None & 0.961 & 0.969 & 0.977 & 0.973 & 0.996 \\
			\hline
		\end{tabular}
	\end{center}
...
\begin{table}
	\begin{center}
		\begin{tabular}{|l|l|l|l|l|l|l|l|}
			...
			Max Features & \# Estimators & Max Depth & Accuracy & Precision & Recall & F1 Score & AUC \\
			\hline
			sqrt & 1000 & None & 0.967 & 0.970 & 0.979 & 0.975 & 0.995 \\
			\hline
			log2 & 1000 & None & 0.967 & 0.970 & 0.980 & 0.975 & 0.994 \\
			\hline
			sqrt & 50 & None & 0.967 & 0.970 & 0.980 & 0.975 & 0.993 \\
			\hline
			sqrt & 150 & None & 0.966 & 0.970 & 0.978 & 0.974 & 0.994 \\
			\hline
			sqrt & 200 & None & 0.966 & 0.970 & 0.978 & 0.974 & 0.994 \\
			\hline
			log2 & 100 & None & 0.966 & 0.968 & 0.980 & 0.974 & 0.993 \\
			\hline
			log2 & 150 & None & 0.965 & 0.966 & 0.981 & 0.974 & 0.993 \\
			\hline
			log2 & 200 & None & 0.965 & 0.968 & 0.979 & 0.973 & 0.994 \\
			\hline
			log2 & 50 & None & 0.964 & 0.967 & 0.979 & 0.973 & 0.992 \\
			\hline
			sqrt & 100 & None & 0.964 & 0.968 & 0.978 & 0.973 & 0.994 \\
			\hline
		\end{tabular}
	\end{center}
...
The data is sorted primarily by accuracy as the most important metric. As the top three mouse data results have the same accuracy value, their AUC is considered next.
