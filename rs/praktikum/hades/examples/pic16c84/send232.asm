...
_ClkIn          equ     200000          ; Input Clock Frequency is 200 khz
_BaudRate       set     300             ; Baud Rate (bits per second) is 300
...
;	movf    RxReg,W                 ; WREG = Received byte


        movlw   85                      ; send a 'U' character
	movwf   TxReg                   ;  
;
; Echo byte
;
